...
public interface Connection  extends Wrapper, AutoCloseable {
     ...
     * or this method is called on a closed connection
     */
    java.sql.CallableStatement prepareCall(String sql) throws java.sql.SQLException;
     ...
     * or this method is called on a closed connection
     */
    String nativeSQL(String sql) throws java.sql.SQLException;
     ...
     * @exception java.sql.SQLException if a database access error occurs, this
     ...
     */
    SQLWarning getWarnings() throws java.sql.SQLException;
     ...
     * pre-compiled SQL statement that will produce <code>ResultSet</code>
     * objects with the given type and concurrency
     * @exception java.sql.SQLException if a database access error occurs, this method
     ...
     * @since 1.2
     */
    java.sql.CallableStatement prepareCall(String sql, int resultSetType,
     ...
     * @exception java.sql.SQLFeatureNotSupportedException if the given holdability is not supported
     * @see #getHoldability
     ...
     * @since 1.4
     */
    Savepoint setSavepoint() throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    Savepoint setSavepoint(String name) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    void rollback(Savepoint savepoint) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    void releaseSavepoint(Savepoint savepoint) throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    Clob createClob() throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    Blob createBlob() throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    NClob createNClob() throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    SQLXML createSQLXML() throws java.sql.SQLException;
         ...
         * @exception java.sql.SQLException if the value supplied for <code>timeout</code>
         * is less then 0
         * @since 1.6
         *
...
/**
  ...
  * Types for the given class of <code>Object</code>. The default
...
throws java.sql.SQLException;
    ...
    * @since 1.7
    */
    void setSchema(String schema) throws java.sql.SQLException;
     ...
     * @since 1.7
     */
    String getSchema() throws java.sql.SQLException;
     ...
     * @since 1.7
     */
    void abort(Executor executor) throws java.sql.SQLException;
     ...
     * @since 1.7
     */
    void setNetworkTimeout(Executor executor, int milliseconds) throws java.sql.SQLException;
