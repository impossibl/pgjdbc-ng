...
public interface ResultSet extends Wrapper, AutoCloseable {
     ...
     * Retrieves the value of the designated column in the current row
     * of this <code>ResultSet</code> object as
     * a <code>Time</code> object in the Java programming language.
     *
     * @param columnIndex the first column is 1, the second is 2, ...
     * @return the column value; if the value is SQL <code>NULL</code>, the
     * value returned is <code>null</code>
     ...
     * Retrieves the value of the designated column in the current row
     * of this <code>ResultSet</code> object as
     * a <code>Timestamp</code> object in the Java programming language.
     *
     * @param columnIndex the first column is 1, the second is 2, ...
     * @return the column value; if the value is SQL <code>NULL</code>, the
     * value returned is <code>null</code>
    ...
    /**
     * Updates the designated column with a <code>Time</code> value.
     * The updater methods are used to update column values in the
     * current row or the insert row.  The updater methods do not
     * update the underlying database; instead the <code>updateRow</code> or
     * <code>insertRow</code> methods are called to update the database.
    ...
    /**
     * Updates the designated column with a <code>Timestamp</code>
     * value.
     * The updater methods are used to update column values in the
     * current row or the insert row.  The updater methods do not
     * update the underlying database; instead the <code>updateRow</code> or
     ...
     * @since 1.2
     */
    java.sql.Ref getRef(int columnIndex) throws SQLException;
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>ResultSet</code> object as a <code>Date</code> object
     * in the Java programming language.
     ...
     * @return the column value as a <code>Date</code> object;
     * if the value is SQL <code>NULL</code>,
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>ResultSet</code> object as a <code>Time</code> object
     * in the Java programming language.
     * This method uses the given calendar to construct an appropriate millisecond
     ...
     * @return the column value as a <code>Time</code> object;
     * if the value is SQL <code>NULL</code>,
     * the value returned is <code>null</code> in the Java programming language
     * @exception SQLException if the columnIndex is not valid;
     * if a database access error occurs
    ...
    /**
     * Retrieves the value of the designated column in the current row
     * of this <code>ResultSet</code> object as a <code>Timestamp</code> object
     * in the Java programming language.
     * This method uses the given calendar to construct an appropriate millisecond
     ...
     * @return the column value as a <code>Timestamp</code> object;
     * if the value is SQL <code>NULL</code>,
     * the value returned is <code>null</code> in the Java programming language
     * @exception SQLException if the columnIndex is not valid;
     * if a database access error occurs
    ...
    /**
     * Updates the designated column with a <code>Array</code> value.
     * The updater methods are used to update column values in the
     * current row or the insert row.  The updater methods do not
     * update the underlying database; instead the <code>updateRow</code> or
     * <code>insertRow</code> methods are called to update the database.
     ...
     * <code>ResultSet</code> object as a <code>RowId</code> object in the Java
     ...
     * @since 1.6
     */
    java.sql.RowId getRowId(int columnIndex) throws SQLException;
     ...
     * @since 1.6
     */
    java.sql.RowId getRowId(String columnLabel) throws SQLException;
     ...
     * @since 1.6
     */
    void updateRowId(int columnIndex, java.sql.RowId x) throws SQLException;
    ...
    /**
     * Updates the designated column with a <code>NClob</code> value.
     * The updater methods are used to update column values in the
     * current row or the insert row.  The updater methods do not
     * update the underlying database; instead the <code>updateRow</code> or
     * <code>insertRow</code> methods are called to update the database.
     ...
     * @since 1.6
     */
    void updateNClob(int columnIndex, java.sql.NClob nClob) throws SQLException;
     ...
     * @since 1.6
     */
    void updateNClob(String columnLabel, java.sql.NClob nClob) throws SQLException;
     ...
     * @since 1.6
     */
    java.sql.NClob getNClob(int columnIndex) throws SQLException;
   ...
   * if the driver does not support national
     ...
     * @since 1.6
     */
    java.sql.SQLXML getSQLXML(int columnIndex) throws SQLException;
     ...
     * @since 1.6
     */
    java.sql.SQLXML getSQLXML(String columnLabel) throws SQLException;
    /**
     * Updates the designated column with a <code>SQLXML</code> value.
     * The updater
     * methods are used to update column values in the current row or the insert
     * row. The updater methods do not update the underlying database; instead
     * the <code>updateRow</code> or <code>insertRow</code> methods are called
     ...
     * @since 1.6
     */
    void updateSQLXML(int columnIndex, java.sql.SQLXML xmlObject) throws SQLException;
    /**
     * Updates the designated column with a <code>SQLXML</code> value.
     * The updater
     * methods are used to update column values in the current row or the insert
