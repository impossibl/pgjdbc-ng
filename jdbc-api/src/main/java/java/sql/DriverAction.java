...
/**
 * An interface that must be implemented when a {@linkplain java.sql.Driver} wants to be
 ...
 * {@linkplain java.sql.DriverManager#registerDriver(java.sql.Driver, DriverAction) } in order
...
public interface DriverAction {
    /**
     * Method called by
     * {@linkplain java.sql.DriverManager#deregisterDriver(java.sql.Driver) }
     ...
     * on its behavior.
     * @see java.sql.DriverManager#registerDriver(java.sql.Driver, DriverAction)
