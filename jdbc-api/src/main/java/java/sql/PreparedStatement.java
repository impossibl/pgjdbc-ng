...
public interface PreparedStatement extends java.sql.Statement {
     ...
     * @exception java.sql.SQLException if parameterIndex does not correspond to a parameter
    ...
    */
     ...
     * @since 1.2
     */
    void setRef (int parameterIndex, Ref x) throws java.sql.SQLException;
     ...
     * @since 1.2
     */
    void setBlob (int parameterIndex, Blob x) throws java.sql.SQLException;
     ...
     * @since 1.2
     */
    void setClob (int parameterIndex, Clob x) throws java.sql.SQLException;
     ...
     * @since 1.2
     */
    void setArray (int parameterIndex, Array x) throws java.sql.SQLException;
  ...
  void setNull (int parameterIndex, int sqlType, String typeName)
     ...
     * @since 1.4
     */
    ParameterMetaData getParameterMetaData() throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    void setRowId(int parameterIndex, RowId x) throws java.sql.SQLException;
     ...
     * @since 1.6
     */
     void setNString(int parameterIndex, String value) throws java.sql.SQLException;
     ...
     * @since 1.6
     */
     void setNCharacterStream(int parameterIndex, Reader value, long length) throws java.sql.SQLException;

    /**
     * Sets the designated parameter to a <code>NClob</code> object. The driver converts this to a
     ...
     * @since 1.6
     */
     void setNClob(int parameterIndex, NClob value) throws java.sql.SQLException;
     ...
     */
     ...
     /**
      * Sets the designated parameter to the given <code>SQLXML</code> object.
     ...
     * marker in the SQL statement; if a database access error occurs;
      ...
      * @since 1.6
      */
     void setSQLXML(int parameterIndex, SQLXML xmlObject) throws java.sql.SQLException;
     ...
     * @param scaleOrLength for <code>Types.DECIMAL</code>
     *          or <code>Types.NUMERIC types</code>,
  ...
  /**
     ...
     * @since 1.6
     */
     void setNCharacterStream(int parameterIndex, Reader value) throws java.sql.SQLException;
     ...
     *          of the data in the stream or reader.  For all other types,
     *          this value will be ignored.
     * @exception java.sql.SQLException if parameterIndex does not correspond to a
