...
public interface Blob {
   ...
   * @since 1.2
   */
  long position(Blob pattern, long start) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    int setBytes(long pos, byte[] bytes) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    int setBytes(long pos, byte[] bytes, int offset, int len) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    java.io.OutputStream setBinaryStream(long pos) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    void truncate(long len) throws java.sql.SQLException;
