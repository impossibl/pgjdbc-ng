...
{drivername} aims to be a JDBC compliant {jdbc-driver-type4}[type 4] driver,
supporting JDBC 4.2 onwards. A stated goal of the project is to implement all the advanced features of JDBC that
{vendorname} is able to support; including User Defined Types (aka composite types), Arrays of primitive and
composite types, asynchronous notifications, and more.
