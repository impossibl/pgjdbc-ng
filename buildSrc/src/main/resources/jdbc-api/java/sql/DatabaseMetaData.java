...
public interface DatabaseMetaData extends Wrapper {
     ...
     * possible values are defined in <code>Connection</code>.
     *
     ...
     */
    java.sql.ResultSet getProcedures(String catalog, String schemaPattern,
     ...
     *      </UL>
     *  <LI><B>DATA_TYPE</B> int {@code =>} SQL type from Types
     ...
     * @see #getSearchStringEscape
     */
    java.sql.ResultSet getProcedureColumns(String catalog,
    ...
    * returned by the method <code>getProcedureColumns</code>.
     ...
     * @see #getSearchStringEscape
     */
    java.sql.ResultSet getTables(String catalog, String schemaPattern,
     ...
     *      Ref type, SQL type from Types (<code>null</code> if DATA_TYPE
     ...
     * @see #getSearchStringEscape
     */
    java.sql.ResultSet getColumns(String catalog, String schemaPattern,
     ...
     * @see #getSearchStringEscape
     */
    java.sql.ResultSet getColumnPrivileges(String catalog, String schema,
     ...
     * @see #getSearchStringEscape
     */
    java.sql.ResultSet getTablePrivileges(String catalog, String schemaPattern,
     ...
     *      </UL>
     *  <LI><B>COLUMN_NAME</B> String {@code =>} column name
     *  <LI><B>DATA_TYPE</B> int {@code =>} SQL data type from Types
     *  <LI><B>TYPE_NAME</B> String {@code =>} Data source dependent type name,
     *  for a UDT the type name is fully qualified
     ...
     * @exception java.sql.SQLException if a database access error occurs
     */
    java.sql.ResultSet getBestRowIdentifier(String catalog, String schema,
                                            String table, int scope, boolean nullable) throws java.sql.SQLException;
     ...
     *  <LI><B>COLUMN_NAME</B> String {@code =>} column name
     *  <LI><B>DATA_TYPE</B> int {@code =>} SQL data type from <code>Types</code>
     *  <LI><B>TYPE_NAME</B> String {@code =>} Data source-dependent type name
     *  <LI><B>COLUMN_SIZE</B> int {@code =>} precision
     ...
     * @exception java.sql.SQLException if a database access error occurs
     */
    java.sql.ResultSet getVersionColumns(String catalog, String schema,
     ...
     * @exception java.sql.SQLException if a database access error occurs
     */
    java.sql.ResultSet getPrimaryKeys(String catalog, String schema,
                                      String table) throws java.sql.SQLException;
     ...
     * @see #getExportedKeys
     */
    java.sql.ResultSet getImportedKeys(String catalog, String schema,
                                       String table) throws java.sql.SQLException;
     ...
     * @see #getImportedKeys
     */
    java.sql.ResultSet getExportedKeys(String catalog, String schema,
                                       String table) throws java.sql.SQLException;
     ...
     * @exception java.sql.SQLException if a database access error occurs
     */
    java.sql.ResultSet getIndexInfo(String catalog, String schema, String table,
     ...
     *
     * @param type defined in <code>ResultSet</code>
     * @return <code>true</code> if so; <code>false</code> otherwise
     * @exception java.sql.SQLException if a database access error occurs
     * @see java.sql.Connection
     * @since 1.2
     ...
     *
     * @param type defined in <code>ResultSet</code>
     * @param concurrency type defined in <code>ResultSet</code>
     * @return <code>true</code> if so; <code>false</code> otherwise
     * @exception java.sql.SQLException if a database access error occurs
     * @see java.sql.Connection
     * @since 1.2
     ...
     *  <LI><B>DATA_TYPE</B> int {@code =>} type value defined in Types.
     ...
     *     type as defined in Types (<code>null</code> if DATA_TYPE is not
     ...
     * @since 1.2
     */
    java.sql.ResultSet getUDTs(String catalog, String schemaPattern,
     ...
     * @exception java.sql.SQLException if a datanase access error occurs
     * @since 1.4
     */
     ...
     * @since 1.4
     */
    java.sql.ResultSet getSuperTypes(String catalog, String schemaPattern,
                                     String typeNamePattern) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    java.sql.ResultSet getSuperTables(String catalog, String schemaPattern,
                                      String tableNamePattern) throws java.sql.SQLException;
     ...
     *  <LI><B>DATA_TYPE</B> int {@code =>} attribute type SQL type from Types
     ...
     * @since 1.4
     */
    java.sql.ResultSet getAttributes(String catalog, String schemaPattern,
     ...
     * @since 1.6
     */
    RowIdLifetime getRowIdLifetime() throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    java.sql.ResultSet getSchemas(String catalog, String schemaPattern) throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    java.sql.ResultSet getFunctions(String catalog, String schemaPattern,
                                    String functionNamePattern) throws java.sql.SQLException;
    /**
     ...
     * @since 1.6
     */
    java.sql.ResultSet getFunctionColumns(String catalog,
                                          String schemaPattern,
