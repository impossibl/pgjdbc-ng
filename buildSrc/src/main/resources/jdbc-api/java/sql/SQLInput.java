...
public interface SQLInput {
    ...
    /**
     * Reads the next attribute in the stream and returns it as a <code>Date</code> object.
     *
     * @return the attribute; if the value is SQL <code>NULL</code>, returns <code>null</code>
     * @exception java.sql.SQLException if a database access error occurs
     * @exception java.sql.SQLFeatureNotSupportedException if the JDBC driver does not support
     ...
     * @since 1.2
     */
    Date readDate() throws java.sql.SQLException;

    /**
     * Reads the next attribute in the stream and returns it as a <code>Time</code> object.
     *
     * @return the attribute; if the value is SQL <code>NULL</code>, returns <code>null</code>
     * @exception java.sql.SQLException if a database access error occurs
     * @exception java.sql.SQLFeatureNotSupportedException if the JDBC driver does not support
     ...
     * @since 1.2
     */
    Time readTime() throws java.sql.SQLException;

    /**
     * Reads the next attribute in the stream and returns it as a <code>Timestamp</code> object.
     *
     * @return the attribute; if the value is SQL <code>NULL</code>, returns <code>null</code>
     * @exception java.sql.SQLException if a database access error occurs
     * @exception java.sql.SQLFeatureNotSupportedException if the JDBC driver does not support
     ...
     * @since 1.2
     */
    Timestamp readTimestamp() throws java.sql.SQLException;
     ...
     * @since 1.2
     */
    Ref readRef() throws java.sql.SQLException;
     ...
     * @since 1.2
     */
    Blob readBlob() throws java.sql.SQLException;
     ...
     * @since 1.2
     */
    Clob readClob() throws java.sql.SQLException;
     ...
     * @since 1.2
     */
    Array readArray() throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    NClob readNClob() throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    SQLXML readSQLXML() throws java.sql.SQLException;
     ...
     * @since 1.6
     */
    RowId readRowId() throws java.sql.SQLException;
