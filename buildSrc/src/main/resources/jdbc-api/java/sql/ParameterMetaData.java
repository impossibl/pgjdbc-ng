...
public interface ParameterMetaData extends Wrapper {
     ...
     *
     * @param param the first parameter is 1, the second is 2, ...
     * @return SQL type from <code>Types</code>
     * @exception java.sql.SQLException if a database access error occurs
     * @since 1.4
     * @see Types
     */
     ...
     * @since 1.4
     */
    String getParameterTypeName(int param) throws java.sql.SQLException;
     ...
     * @since 1.4
     */
    String getParameterClassName(int param) throws java.sql.SQLException;
