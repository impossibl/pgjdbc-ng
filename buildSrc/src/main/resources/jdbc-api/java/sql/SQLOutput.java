 ...
 */
 ...
 public interface SQLOutput {
   ...
   * @since 1.2
   */
  void writeString(String x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeBoolean(boolean x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeByte(byte x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeShort(short x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeInt(int x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeLong(long x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeFloat(float x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeDouble(double x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeBigDecimal(java.math.BigDecimal x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeBytes(byte[] x) throws java.sql.SQLException;

  /**
   * Writes the next attribute to the stream as a Date object.
   * Writes the next attribute to the stream as a <code>Date</code> object
   * in the Java programming language.
   *
   * @param x the value to pass to the database
   * @exception java.sql.SQLException if a database access error occurs
   ...
   * @since 1.2
   */
  void writeDate(Date x) throws java.sql.SQLException;

  /**
   * Writes the next attribute to the stream as a Time object.
   * Writes the next attribute to the stream as a <code>Date</code> object
   * in the Java programming language.
   *
   * @param x the value to pass to the database
   ...
   * @since 1.2
   */
  void writeTime(Time x) throws java.sql.SQLException;

  /**
   * Writes the next attribute to the stream as a Timestamp object.
   * Writes the next attribute to the stream as a <code>Date</code> object
   * in the Java programming language.
   *
   * @param x the value to pass to the database
   ...
   * @since 1.2
   */
  void writeTimestamp(Timestamp x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeCharacterStream(java.io.Reader x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeAsciiStream(java.io.InputStream x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeBinaryStream(java.io.InputStream x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeObject(SQLData x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeRef(Ref x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeBlob(Blob x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeClob(Clob x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeStruct(Struct x) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  void writeArray(Array x) throws java.sql.SQLException;
      ...
      * @since 1.4
      */
     void writeURL(java.net.URL x) throws java.sql.SQLException;
   ...
   * @since 1.6
   */
  void writeNString(String x) throws java.sql.SQLException;
   ...
   * @since 1.6
   */
  void writeNClob(NClob x) throws java.sql.SQLException;
   ...
   * @since 1.6
   */
  void writeRowId(RowId x) throws java.sql.SQLException;
   ...
   * @since 1.6
   */
  void writeSQLXML(SQLXML x) throws java.sql.SQLException;
