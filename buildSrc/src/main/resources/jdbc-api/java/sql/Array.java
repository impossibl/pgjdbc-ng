...
public interface Array {
   ...
   * @exception java.sql.SQLException if an error occurs while attempting
   ...
   * @exception java.sql.SQLException if an error occurs while attempting to
   * access the array
   * @exception java.sql.SQLFeatureNotSupportedException if the JDBC driver does not support
   * this method
   * @since 1.2
   ...
   * @since 1.2
   */
  Object getArray(java.util.Map<String,Class<?>> map) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  Object getArray(long index, int count) throws java.sql.SQLException;
   ...
   *
   * @return a {@link java.sql.ResultSet} object containing one row for each
   ...
   * @since 1.2
   */
  java.sql.ResultSet getResultSet (java.util.Map<String,Class<?>> map) throws java.sql.SQLException;
   ...
   * @since 1.2
   */
  java.sql.ResultSet getResultSet(long index, int count) throws java.sql.SQLException;
