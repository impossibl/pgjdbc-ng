 ...
 * <p>
 * A JDBC driver may create a {@linkplain java.sql.DriverAction} implementation in order
 * to receive notifications when {@linkplain java.sql.DriverManager#deregisterDriver} has
 * been called.
 * @see DriverManager
...
public interface Driver {
     ...
     * @exception java.sql.SQLException if a database access error occurs or the url is
     * {@code null}
     */
     ...
     * {@code null}
     */
    boolean acceptsURL(String url) throws java.sql.SQLException;
     ...
     * @throws java.sql.SQLFeatureNotSupportedException if the driver does not use
